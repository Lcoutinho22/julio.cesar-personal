...
function toggleTheme() {
        ...
        const translations = {
            pt: {
                ...
                plan_presential_discount: "<i class='fas fa-users'></i> Casal ou dois amigos: 30% de desconto",
            ...
            en: {
                ...
                plan_presential_discount: "<i class='fas fa-users'></i> Couple or two friends: 30% discount",
            ...
            es: {
                ...
                plan_presential_discount: "<i class='fas fa-users'></i> Pareja o dos amigos: 30% de descuento",
